...
public final class Aes256Class {
    private static Aes256Class instance = new Aes256Class();

    private Cipher cipher;
    private Key key;

    public static Aes256Class getInstance() {

        return Aes256Class.instance;
    }
    ...
    private Aes256Class() {
        ...
        try {
            ...
            byte[] raw = {(byte) 0xA5, (byte) 0x01, (byte) 0x7B, (byte) 0xE5,
                    ...
                    (byte) 0x0B, (byte) 0x9A, (byte) 0x3C, (byte) 0xF5};
